...
draw.text((15,10), 'Iniciando', font=font)
draw.text((20,30), 'Sistema', font=font)
...
while True:
    ...
    if gpio.input(20) == gpio.LOW:
        ...
        draw2.text((15,10), 'Aguardando', font=font)
        draw2.text((20,30), 'Consulta', font=font)
        ...
        draw3.text((15,10), 'Capturando', font=font)
        draw3.text((25,30), 'Imagem', font=font)
        ...
        draw4.text((1,10), 'Checando banco', font=font)
        draw4.text((15,30), 'de dados', font=font)
         # Display image.
        disp.image(image4)
        disp.display()
        ...
        for face_encoding in face_encodings:
            ...
            draw7.text((10,10), 'Procurado:', font=font)
            draw7.text((15,30),name1, font=font)
            disp.image(image7)
            disp.display()
